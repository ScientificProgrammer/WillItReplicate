---
title: "Will It Replicate - Introduction"
author: "Eric Milgram"
date: "4/11/2017"
...
The goal of this website is to illustrate concepts related to the application of statistics in scientific contexts, which include designed experiments and observational studies, and incorporating principles of *Reproducible Research*.

Both of the authors of this website are very concerned about the public's growing distrust of conclusions drawn from scientific studies. In 2005, [Dr. John P. A. Ionnidis](https://en.wikipedia.org/wiki/John_Ioannidis) published an in PLoS - Medicine titled [Why Most Published Research Findings Are False](http://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.0020124), wherein he explained the scope of the problem and gave some recommendations based on sound statistical principles for addressing this serious problem. The authors of this website believe strongly that an important component for increasing the quality of scientific conclusions is to use the principles of *Reproducible Research* (see the next item for more information).
...
### Material Presented in formats the Enable Reproducible Research
...
The block of code shown below was used to generate the figure below the code block. If you would like to run the code yourself, simply copy and paste it into R. We recommend the use of R-Studio, which is free can be downloaded at [https://www.rstudio.com/products/rstudio/download/](https://www.rstudio.com/products/rstudio/download/), but before installing R-Studio, you need to have a current version of R installed. The R software can be downloaded at [https://www.r-project.org/](https://www.r-project.org/).
